                              ...
                              <div className="flex items-center justify-between p-4 border-b">
                                  ...
                                  {!chapter.collapsed && (
                                    <div className="p-4">
                                      ...
                                      <div className="inline-flex p-2 mt-2 bg-gray-100 rounded 
                                      cursor-pointer" onClick={() => handleLecture('add', chapter.chapterId)}>+ Add Lecture</div>
                                    </div>
                                  )}
                              </div>
                         ))}
                         <div className="flex items-center justify-center p-2 bg-blue-100 rounded-lg cursor-pointer"
                         ...
                         {showPopup && (
                          <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/50">
                            <div className="relative w-full p-4 text-gray-700 bg-white rounded max-w-80">
                              ...
                              className="absolute w-4 cursor-pointer top-4 right-4" alt="" />
                            </div>
                          </div>
                         )}
                     </div>
                     <button type="submit" className="text-white bg-black w-max py-2.5 px-8 rounded my-4">
                      ADD
                     </button>
                </form>
          </div>
